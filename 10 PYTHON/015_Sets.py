...
miSet = {"manzana", "banana", "cereza", "cereza"}
print(miSet)
...
#   Uso de SET para eliminar elementos duplicados de un ARRAY:
# Array con elementos duplicados
array_con_duplicados = [1, 2, 2, 3, 4, 4, 5, 6, 6]

# Convertir el array en un set para eliminar duplicados
array_sin_duplicados = list(set(array_con_duplicados))

print("Array original:", array_con_duplicados)
print("Array sin duplicados:", array_sin_duplicados)
